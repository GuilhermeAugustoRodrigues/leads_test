...
router.post(
  "/employeeSkill",
  [isAuthenticated],
  EmployeeSkillController.create
);
router.get(
  "/employeeSkill/:id",
  [isAuthenticated],
  EmployeeSkillController.findOne
);
router.put(
  "/employeeSkill/:id",
  [isAuthenticated],
  EmployeeSkillController.update
);
router.delete(
  "/employeeSkill/:id",
  [isAuthenticated],
  EmployeeSkillController.destroy
);
...
router.get(
  ...
  [isAuthenticated],
  ProjectController.participants
);
router.get(
  "/project/:id/suggestions",
  [isAuthenticated],
  ProjectController.suggestions
);
router.post(
  "/project/addEmployee",
  [isAuthenticated],
...
router.delete(
  "/project/:id/removeEmployee/:employee",
  [isAuthenticated],
...
router.get(
  "/projectSkill/:id",
  [isAuthenticated],
  ProjectSkillController.findOne
);
router.put(
  "/projectSkill/:id",
  [isAuthenticated],
  ProjectSkillController.update
);
router.delete(
  "/projectSkill/:id",
  [isAuthenticated],
  ProjectSkillController.destroy
);
